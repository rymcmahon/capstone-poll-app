class Donor
	...
	def self.find(cid)
		...
		total_contributions_hash = Unirest.get("http://www.opensecrets.org/api/?method=candSummary&cid=#{cid}&cycle=2014&apikey=#{ENV['opensecrets_api_key']}&output=json").body
